          ...
          <div class="col-2">
              ...
              <form @submit.prevent="register" action="" class="card card-form">
                  ...
                  <div class="form-group">
                      ...
                      <template v-if="!$v.form.name.$error" class="form-form">
                  ...
                  <div class="form-group">
                      ...
                      <template v-if="!$v.form.username.$error" class="form-form">
                          <span v-if="!$v.form.username.required" class="form-error">This field is required</span>
                          <span v-if="!$v.form.username.unique" class="form-error">Username already exists</span>
                      </template>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <template v-if="!$v.form.email.$error" class="form-form">
                          ...
                          <span v-if="!$v.form.email.unique" class="form-error">Email already exists</span>
                      </template>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <template v-if="!$v.form.password.$error" class="form-form">
                  ...
                  <div class="form-group">
                      ...
                      <input v-model.lazy="form.avatar" @blur="$v.form.avatar.$touch()" id="avatar" type="text" class="form-input">
                      <template v-if="!$v.form.avatar.$error" class="form-form">
                          <span v-if="!$v.form.avatar.url" class="form-error">Invalid URL</span>
                          <span v-else-if="!$v.form.avatar.supportedImageFile" class="form-error">This file type is not supported</span>
                      </template>
                  </div>
              ...
              <div class="text-center push-top">
                  <button @click="registerWithGoogle" @blur="$v.form.name.$touch()" class="btn-red btn-xsmall"><i class="fa fa-google fa-btn"></i>Sign up with Google</button>
              </div>
          </div>
      </div>
</template>
