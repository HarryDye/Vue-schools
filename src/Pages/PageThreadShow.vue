<template>
        <div v-if="asyncDataStatus_ready" class="col-large push-top">
            ...
            <p>
                By <a href="#" class="link-unstlyed">{{user.name}}</a>, <AppDate :timestamp="thread.publishedAt"/>

                <span style="float:right; margin-top: 2px;" class="hide-mobile text-faded text-small">{{repliesCount}} replies, {{contributorsCount}} contributors</span>
            </p>
